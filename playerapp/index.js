$(document).ready(function () {
    ...
    let data = playerList.map((ele) => {
        $("#loading").css("display", "none");
        $("#main").css("display", "unset");
      
        max = playerList.length - 1;
        image.attr("src", ele.photo);
        name.html(ele.Name);
        team.html(ele.Team);
        price.html(ele.Price);
        playerType.html(ele.Role);
    ...
    buttonNext.click(function () {
        ...
        image.attr("src", playerList[ind].photo);
        name.html(playerList[ind].Name);
        team.html(playerList[ind].Team);
        price.html(playerList[ind].Price);
        playerType.html(playerList[ind].Role);
    });
